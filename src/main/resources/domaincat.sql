...
insert into `app_config`(`id`,`version`,`web_title`,`sub_title`,`host_url`,`meta_keywords`,`meta_description`,`board_source`,`hidden_source`,`registable`) values (1,'1.0','域猫','come on','http://domaincat.cloudfoundry.com',NULL,NULL,NULL,NULL,1);
